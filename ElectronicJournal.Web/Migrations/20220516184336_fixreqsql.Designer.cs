...
namespace ElectronicJournal.Web.Migrations
{
    ...
    [Migration("20220516184336_fixreqsql")]
    partial class fixreqsql
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectronicJournal.Web.Models.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ElectronicJournal.Web.Models.UserGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ElectronicJournal.Web.Models.Course", b =>
                {
                    b.HasOne("ElectronicJournal.Web.Models.User", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("ElectronicJournal.Web.Models.UserCourse", b =>
                {
                    ...
                    b.HasOne("ElectronicJournal.Web.Models.User", "User")
                        .WithMany("UserCourses")
            ...
            modelBuilder.Entity("ElectronicJournal.Web.Models.UserGroup", b =>
                {
                    b.HasOne("ElectronicJournal.Web.Models.Group", "Group")
                        .WithMany("UserGroups")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ElectronicJournal.Web.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
